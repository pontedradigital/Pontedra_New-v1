      ...
      <section id="pricing" className="py-20 bg-card border-t border-border">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              { name: "Básico", price: "R$99", features: ["1 Canal de Atendimento", "Atendimento Assistente Pontedra Básico", "500 Mensagens/mês", "Suporte por E-mail"], highlight: false },
              { name: "Profissional", price: "R$249", features: ["3 Canais de Atendimento", "Atendimento Assistente Pontedra Avançado", "5.000 Mensagens/mês", "Relatórios e Insights", "Suporte Prioritário"], highlight: true },
