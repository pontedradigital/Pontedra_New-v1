      ...
      >
        ...
        {profile && (
          <p className="text-lg text-[#9ba8b5]">
            Olá, <span className="font-semibold text-white">{profile.first_name}</span>! Aqui você encontrará recursos úteis para o seu papel de <span className="font-semibold text-[#57e389] capitalize">{profile.role}</span>.
