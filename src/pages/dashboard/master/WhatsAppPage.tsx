    ...
    <DashboardLayout>
      ...
      >
        <h1 className="text-4xl font-bold text-[#57e389] mb-6 flex items-center gap-3">
          <MessageCircle className="w-10 h-10" /> WhatsApp Business
        </h1>
        {profile && (
          <p className="text-lg text-[#9ba8b5]">
            Olá, <span className="font-semibold text-white">{profile.first_name}</span>! Esta é a página de gerenciamento do WhatsApp Business.
